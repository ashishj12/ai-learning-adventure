...
import { MissionRepo, QuestionRepo, FlashcardRepo, BadgeRepo, ProgressRepo } from "@/lib/repo";
...
export async function GET(req: NextRequest, { params }: { params: Promise<{ slug: string }> }) {
  try {
    ...
    return NextResponse.json({ mission, questions: safeQuestions, flashcards, badge, progress });
  } catch (err) {
