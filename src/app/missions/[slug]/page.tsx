  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        if (!cancelled)
          setError(
            "Couldn't load this mission. Check your connection and try again.",
          );
      }
    }
    load();
    ...
    return (
      <div className="mx-auto max-w-2xl px-6 py-16 text-center">
        ...
        <p className="mt-2 text-ink/60">
          This mission doesn't exist, or isn't published yet.
        </p>
    ...
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      >
        ...
        >
          ...
          <span className="mt-1 text-xs text-ink/50">
            {flashcards.length} concept cards for this mission
          </span>
