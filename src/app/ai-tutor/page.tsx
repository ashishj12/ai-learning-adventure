  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <h1 className="font-display text-3xl font-semibold text-navy">Ask me anything about AI basics</h1>
        <p className="mt-2 text-ink/60">
          Free-form Q&A with your tutor — ask for simpler explanations, examples, hints, a mission recap, or what to
          learn next. I'll stay focused on the AI literacy content in this app.
        </p>
      </motion.div>
...
export default function AiOnlyModePage() {
  return (
    <Suspense fallback={<div className="mx-auto max-w-2xl px-6 py-10 text-ink/40">Loading…</div>}>
      <AiOnlyModeContent />
    </Suspense>
  );
}
